...
class Train:
    ...
    def train(self, epoch):
        ...
        with tqdm(total=n_dataset, disable=self.disable_progress_bar) as pbar:
            ...
            for batch_id, (fnames, seqs, pairs, dot_brackets, ref_tokens) in enumerate(self.train_loader):
                n_batch = len(seqs)
                ...
                loss, token_acc = self.loss(y, ref_tokens, seqs, fname=fnames, token_stats=gt_token_stats)
    ...
    def loss(self, y, gt_tokens, seqs, dot_brackets=None, fname=None, token_stats=None):
    ...
    def add_args(cls, parser):
        ...
        gparser.add_argument('--model', choices=('transformer', 'bilstm'), default='transformer', help="Model architecture")
