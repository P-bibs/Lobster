...
# sy11: row pair followed by col pair as in https://rna.urmc.rochester.edu/NNDB/parameter_tables/turner_2004_rnastructure/turner_2004_watson_crick_stack_dg.txt
score_stack = np.array([
  # _,   GC,   CG,   UG,   GU,   UA,   AU,   GU/UG/UA
  [ 0,    0,    0,    0,    0,    0,    0,    0, ], # _
  [ 0, -240, -330, -210, -140, -210, -210, -140, ], # CG row
  [ 0, -330, -340, -250, -150, -220, -240, -150, ], # GC
  [ 0, -210, -250, 130,  -50,  -140, -130,  130, ], # GU
  [ 0, -140, -150, -50,   30,  -60,  -100,  30,  ], # UG
  [ 0, -210, -220, -140, -60,  -110, -90,  -60,  ], # AU
  [ 0, -210, -240, -130, -100, -90,  -130, -90,  ], # UA
  [ 0, -140, -150, 130,   30,  -60,  -90,   130, ], # UG (1,2,4,5)/GU (3,7)/GU=AU (6) tandem GU pair, penalize at the ends of helices
], dtype=np.float32) / -100.

# Scores used for hairpin function H(i, j) = H(x[i], x[i+1], l, x[j-1], x[j])
score_mismatch_hairpin = np.array([
  ...
  # Pair Type: CG (x[i],x[j])
  [
    #         --- x[i+1] -->
    # _,      A,    C,    G,   U,
    [ -80, -100, -110, -100, -80, ],   # _    |
    [ -140, -150, -150, -140, -150, ], # A    |
    [ -80, -100, -110, -100, -80, ],   # C  x[j-1]
    [ -150, -230, -150, -240, -150, ], # G    |
    [ -100, -100, -140, -100, -210, ], # U    v
  ],
  # Pair Type: GC
  [
    [ -50, -110, -70, -110, -50, ],
