...
//// override nan equality
//use ordered_float::OrderedFloat;
//impl std::cmp::PartialEq for Value {
//  fn eq(&self, other: &Self) -> bool {
//    use Value::*;
//    match (self, other) {
//      (Self::F32(f1), Self::F32(f2)) => OrderedFloat::from(*f1).eq(&OrderedFloat::from(*f2)),
//      (Self::F64(f1), Self::F64(f2)) => OrderedFloat::from(*f1).eq(&OrderedFloat::from(*f2)),
//      (I8(a),I8(b)) |
//      (I16(a),I16(b)) |
//      (I32(a),I32(b)) |
//      (I64(a),I64(b)) |
...
//      (String(a),String(b)) |
//      (Symbol(a),Symbol(b)) |
//      (SymbolString(a),SymbolString(b)) |
//      (DateTime(a),DateTime(b)) |
//      (Duration(a),Duration(b)) |
//      (Entity(a),Entity(b)) |
//      (EntityString(a),EntityString(b)) |
//      (Tensor(a),Tensor(b)) |
//      (TensorValue(a),TensorValue(b)) => a.eq(b),
//    }
//  }
//}
...
//    use Value::*;
//    match (self, other) {
//      (Self::F32(f1), Self::F32(f2)) => OrderedFloat::from(*f1).partial_cmp(&OrderedFloat::from(*f2)),
//      (Self::F64(f1), Self::F64(f2)) => OrderedFloat::from(*f1).partial_cmp(&OrderedFloat::from(*f2)),
//      (I8(a),I8(b)) |
//      (I16(a),I16(b)) |
//      (I32(a),I32(b)) |
//      (I64(a),I64(b)) |
...
//      (EntityString(a),EntityString(b)) |
//      (Tensor(a),Tensor(b)) |
//      (TensorValue(a),TensorValue(b)) => a.partial_cmp(b),
//    }
//  }
//}
...
impl From<OrderedFloat<f32>> for Value {
  fn from(i: OrderedFloat<f32>) -> Self {
    Self::F32(i)
  }
}
...
impl From<Value> for f32 {
  fn from(v: Value) -> Self {
    match v {
      Value::F32(f) => f.into_inner(),
      _ => panic!("should not happen; input variable to abs should be a number"),
    }
  }
}

//impl TryInto<OrderedFloat<f32>> for Value {
//  type Error = ValueConversionError;
//
//  fn try_into(self) -> Result<OrderedFloat<f32>, Self::Error> {
//    match self {
//      Self::F32(f) => Ok(f),
...
//  }
//}
impl Into<OrderedFloat<f32>> for Value {
  fn into(self) -> OrderedFloat<f32> {
    match self {
      Self::F32(f) => f,
      _ => panic!("should not happen; input variable to abs should be a number"),
    }
